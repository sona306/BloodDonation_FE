...
const ConsumerSignin = () => {
    ...
    return (
        <div className="min-vh-100 d-flex flex-column" style={{ backgroundColor: '#e9ecef', fontFamily: 'Roboto, sans-serif' }}>
            <Navbarlogin />
            <div className="container my-auto">
                <h3 className="text-center">Welcome to Life Saver App</h3>
                <h2 className="text-center mb-4">Consumer Login</h2>
                        ...
                        <div className="card shadow">
                            <div className="card-body">
                                ...
                                <div className="text-center mt-3">
                                    <a href="/consumersignup" className="btn btn-info w-100">Sign Up</a>
                                </div>
                            </div>
                        </div>
                    </div>
